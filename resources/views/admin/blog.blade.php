...
<form id="frm-logout" action="{{ route('logout') }}" method="POST" style="display: none;">
    {{ csrf_field() }}
                    ...
                    <div class="col-md-12">
                        <div class="card card-padding">
                            <div class="header">
                             ...
                             <a href="{{ route('admin.blog_add') }}"><button type="button" >Add Blog</button></a>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <form class="aboutbody" method="post" enctype="multipart/form-data">
                                            <td><input class="inputstyle" type="text" name="blog_title"value="{{$blogs->blog_title}}"></td>
                                        <td>
                                            <input class="inputstyle" type="file" name="blog_image"  value="{{$blogs->blog_image}}">
                                            <img src="{{ url('/uploads/blog_profile/') }}/{{$blogs->blog_image}}" width="100px" height="100px">
                                        </td>
                                            <td><input class="inputstyle" type="textarea" name="blog_descr" value="{{$blogs->blog_descr}}"></td>
                                            <td><input class="inputstyle" type="textarea" name="blog_link" value="{{$blogs->blog_link}}"></td>
            <td>
                <div class="form-group">
                    <label>
                        <input type="radio" name="blog_status" value="1" <?php if($blogs->blog_status=='1'){ echo 'checked';}?> class="minimal-red" >Active
                    </label>
                    <label>
                        <input type="radio" name="blog_status" value="0" <?php if($blogs->blog_status=='0'){ echo 'checked';}?> class="minimal-red">Inactive
                    </label>
                </div>
            </td>
            ...
            <td>
                <div class="form-group">
                {{csrf_field()}}
                 <button type="submit" name="up" value="{{$blogs->blog_id}}">UPDATE</button>
            </div>
             </td>
    </form>
</tr>
