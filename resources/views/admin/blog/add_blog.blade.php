                    ...
                    <div class="col-md-12">
                        <div class="card card-padding">
                            <div class="header">
                                ...
                                <a href="{{ route('admin.blog') }}"><button type="button" > Blog List</button></a>
                            </div>
<form class="aboutbody" action="{{ route('admin.addblog')}}" method="post" role="form" enctype="multipart/form-data">



                <div class="form-group">
                  <label for="exampleInputUsers1">BLOG NAME : </label>
                  <input class="inputstyle" type="text" name="blog_title" value="">
                </div>

                <div class="form-group">
                    <label for="imageInput">BLOG Image</label>
                    <input class="inputstyle" type="file" name="blog_image"  value="">
                    <img class="col-sm-6" id="preview"  src="">
                </div>


                <div class="form-group">
                  <label for="exampleInputUsers1">BLOG DESCRIPTION</label>
                  <input class="inputstyle" type="textarea" name="blog_descr" value="">
                </div>

                <div class="form-group">
                  <label for="exampleInputUsers1">BLOG LINK</label>
                  <input class="inputstyle" type="textarea" name="blog_link" value="">
                </div>

                <div class="form-group">
                      <label>Blog Status</label>
                    <label>
                      <input type="radio" name="blog_status" value="1" class="minimal-red" checked>
                      Active
                    </label>
                    <label>
                      <input type="radio" name="blog_status" value="0" class="minimal-red">
                      Inactive
                    </label>
                </div>
