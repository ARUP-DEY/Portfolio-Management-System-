...
">Login</a></li>
        ...
        <div class="wdm_hx_rightpart">
            <div class="rightpart_inner">
                ...
                <div id="services_wrap_new"class="wdm_hx_services_wrap services_wrap_new">
                    <div class="container">
                            ...
                            @foreach($blog as $blogs)
                                <li>
                                    <div class="inner">
                                        <ul class="price_new">
                                        <div class="icon">
                                          <img class="img-responsive" src="{{ url('/uploads/blog_profile/') }}/{{$blogs->blog_image}}"/>
                                            </div>
                                        <div class="title_service">
                                            <h3>{{$blogs->blog_title}}</h3>
                                        </div>
                                        <!-- <div class="text">
                                            <p>{{$blogs->blog_descr}}</p>
                                        </div> -->
                                        <div>
                                        <a href="{{ route('blog-details', $blogs->blog_id) }}" class="button_new">Read More..</a>
                                    </div>
                                        </ul>
                                    </div>
                                </li>
