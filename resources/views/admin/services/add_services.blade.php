                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        <div class="card card-padding">
                            <div class="header">
                                <h4 class="title">SERVICES PANEL</h4>
                                <a href="{{ route('admin.services') }}"><button type="button" >Services List</button></a>
                            </div>
                            <div >
<form class="aboutbody" action="{{ route('admin.addservices')  }}" method="post" role="form" enctype="multipart/form-data">

                    <div class="form-group">
                            <label for="exampleInputUsers1">SERVICE TYPE: </label>
                            <input class="inputstyle" type="text" name="type" value="">
                    </div>
                    <div class="form-group">
                            <label for="exampleInputUsers1">SERVICE NAME :</label>
                            <input class="inputstyle" type="textarea" name="service_name" value="">
                    </div>
