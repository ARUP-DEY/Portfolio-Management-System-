    ...
    <div id="wdm_hx_popup_blog">
        ...
        <span class="close"><a href="#"></a></span>
               ...
               <a href="<?php echo url('skills') ?>">Skills</a>
                <a href="<?php echo url('') ?>">Projects</a>
                        ...
                        <div class="wdm_hx_services_wrap">
                            <div class="container">
                                <div class="wdm_hx_title_holder">
                                    <h3 class="button_new">{{ $blog->blog_title }}</h3>

                                    
                                </div>

                                <div class="row">
                                    <img class="img-responsive" src="{{ url('/uploads/blog_profile/') }}/{{$blog->blog_image}}"/>
                                    
                                </div>
                                <br><br><br>
                                <li><h>{{ $blog->blog_descr }}</h></li>
                                <br><br>

                                <li><h><a href="" class="social-icon"></a>{{ $blog->blog_link }}</h></li>
