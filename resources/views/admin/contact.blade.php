                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        <div class="card card-padding">
                            <div class="header">
                                <h4 class="title">CONTACTS PANEL</h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    <form class="aboutbody"method="post">
                                        ...
                                        <tr>
                                            <td><input class="inputstyle" type="text" name="contact_address"  value="{{$contacts->contact_address}}"></td>
                                        	<td>{{csrf_field()}}
                                            <button type="submit" name="up" value="{{$contacts->contact_id}}">UPDATE</button></td>
                                            </tr>

                                            <tr>
                                            <td><input class="inputstyle" type="text" name="contact_email"  value="{{$contacts->contact_email}}"></td>
                                        	<td>{{csrf_field()}}
                                            <button type="submit" name="up" value="{{$contacts->contact_id}}">UPDATE</button></td>
                                            </tr>
                                            ...
                                            <tr>
                                            <td><input class="inputstyle" type="text" name="contact_no"  value="{{$contacts->contact_no}}"></td>
                                        	<td>{{csrf_field()}}
                                            <button type="submit" name="up" value="{{$contacts->contact_id}}">UPDATE</button></td>
                                            </tr>

                                            <tr>
                                            <td><input class="inputstyle" type="text" name="contact_website"  value="{{$contacts->contact_website}}"></td>
                                        	<td>{{csrf_field()}}
                                            <button type="submit" name="up" value="{{$contacts->contact_id}}">UPDATE</button></td>
                                            </tr>
