		...
		<div class="wdm_hx_rightpart">
								...
								<div class="author_wrap">
									<div class="leftbox">
											...
											<div class="image layer" data-depth="0.1">
												...
												<div class="inner" data-img-url="{{$abouts->pimage}}"></div>
											</div>
											<div class="border layer" data-depth="0.2">
												<img src="{{$abouts->pimage}}" alt="" />
			...
			<br>
										...
										<div class="about_short_contact_wrap">
											<ul>
												<li>
													<span><label>CV:</label>{{$abouts->cv}}</span>
												</li>
												<li>
												...
												<li>
													<span><label>Phone:</label> <a href="#">+91 8170012839</a></span>
												</li>
												<li>
													<span><label>Address:</label> <a href="#">{{$abouts->city}}</a></span>
												</li>
											</ul>
										</div>
										<div class="buttons_wrap">
											<ul>
												<li class="button">
													<a href="{{ url('/uploads/upload_cv/') }}/{{$abouts->cv}}" download><span>Download CV</span></a>
												</li>
