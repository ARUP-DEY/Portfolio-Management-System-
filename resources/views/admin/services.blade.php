                    ...
                    <div class="col-md-12">
                        <div class="card card-padding">
                            <div class="header">
                                ...
                                <a href="{{ route('admin.services_add') }}"><button type="button" >Add Services</button></a>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input class="inputstyle" type="text" name="type"  value="{{$selects->type}}"></td>
                                            <td><input class="inputstyle" type="text" name="service_name" value="{{$selects->service_name}}"></td>

                                        	<td> {{csrf_field()}}
                                            <button type="submit" name="up" value="{{$selects->service_id}}">UPDATE</button></td>
                                            </form></tr>
                                            @endforeach
